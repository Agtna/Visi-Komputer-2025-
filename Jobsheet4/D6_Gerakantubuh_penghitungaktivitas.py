...
def ratio_pushup(lm):
    if len(lm) > 23:  # Pastikan bahwa elemen untuk shoulder, wrist, dan hip ada
        ...
        # Jika data tidak lengkap, kembalikan nilai default
        return 1.0  # Atau bisa return None dan tangani kasus ini lebih lanjut
